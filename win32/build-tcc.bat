...
rem @if _%PROCESSOR_ARCHITECTURE%_==_AMD64_ goto x86_64
...
:x86_64
rem @set target=-DTCC_TARGET_PE -DTCC_TARGET_X86_64
rem @rem mingw 64 has an ICE with -Os
rem @set CC=gcc -O0 -s -fno-strict-aliasing
rem @set P=64
@goto tools
